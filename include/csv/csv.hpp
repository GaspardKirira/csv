...
#define CSV_VERSION_MAJOR 2
/// Minor version component.
#define CSV_VERSION_MINOR 0
/// Patch version component.
#define CSV_VERSION_PATCH 0
/// Encoded integer: (major*10000 + minor*100 + patch).
#define CSV_VERSION (CSV_VERSION_MAJOR * 10000 + CSV_VERSION_MINOR * 100 + CSV_VERSION_PATCH)
...
namespace csv
{
  ...
  {
    return std::to_string(CSV_VERSION_MAJOR) + '.' +
           std::to_string(CSV_VERSION_MINOR) + '.' +
           std::to_string(CSV_VERSION_PATCH);
  }
